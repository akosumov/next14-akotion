	...
	return (
		...
		>
			{!!id && (
				...
				>
					<ChevronIcon className='h-3 w-4 shrink-0 text-muted-foreground/50 ' />
				</div>
			)}
			{documentIcon ? (
				<div className='shronk-0 mr-2 text-[18px]'>{documentIcon}</div>
			) : (
			...
			{!!id && (
				<div className='ml-auto flex items-start gap-x-2'>
					...
					<div
						role='button'
						onClick={onCreate}
						className='opacity group-hover:opacity-100 h-full ml-auto rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600'
					>
